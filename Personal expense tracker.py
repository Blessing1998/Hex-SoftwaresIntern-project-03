#Hex Softwares Intern project 03
#This is my personal expense tracker which allows me to to keep track of my expenses
#and achieve financial freedom
#Important part of savings
#Import all the tools from the import Liabraries
...
dataentery_frame_bg = 'Brown'
buttons_frame_bg = 'Green'
...
root = Tk()
root.title('Blessing Musara Personal Expense Tracker')
